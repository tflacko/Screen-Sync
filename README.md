...
- **The product** → Screen Sync sells its **own** ad space (the `house_web` listing, live on the marketing site): **$20 USDC** exclusive **15-minute slots** (UTC) with optional **outbidding** (+$5 over the holder's bid, highest verified payment wins), and **filler** — $20/day buys 15 minutes of total airtime spread across unbooked windows. **USDC-only, no price oracle.**
